class script(object):
    START_TXT = """<b><blockquote>Hᴇʟʟᴏ {},ᴍʏ ɴᴀᴍᴇ {} </blockquote></b>\n\n<b><blockquote>ɪ ᴀᴍ ᴛʜᴇ ᴍᴏsᴛ ᴘᴏᴡᴇʀғᴜʟ ᴀɴᴅ ᴀᴅᴠᴀɴᴄᴇᴅ ғɪʟᴇ sᴛᴏʀᴇ ʙᴏᴛ + ᴄᴜsᴛᴏᴍ sʜᴏʀᴛɴᴇʀ sᴜᴘᴘᴏʀᴛ + ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ sᴜᴘᴘᴏʀᴛ + ᴀʙᴇsᴛ ᴜɪ ᴘᴇʀғᴏʀᴍᴀɴᴄᴇ🎗</blockquote></b>\n<b><blockquote>ᴛᴏ ᴋɴᴏᴡ ᴀʙᴏᴜᴛ ᴍᴇ ᴍᴏʀᴇ ᴜsᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ 🧨</blockquote></b>"""

   
    CAPTION = """
<b><blockquote>{file_name}</blockquote></b>""" 


    SHORTENER_API_MESSAGE = """<b></blockquote>Tᴏ ᴀᴅᴅ ᴏʀ ᴜᴘᴅᴀᴛᴇ ʏᴏᴜʀ Sʜᴏʀᴛɴᴇʀ Wᴇʙsɪᴛᴇ API, /api (ᴀᴘɪ)
            
<b>Ex: /api 𝟼LZǫ𝟾𝟻𝟷sXᴏғғғPHᴜɢɪKQǫ

<b>Cᴜʀʀᴇɴᴛ Wᴇʙsɪᴛᴇ: {base_site}

Cᴜʀʀᴇɴᴛ Sʜᴏʀᴛᴇɴᴇʀ API:`{shortener_api}`

If You Want To Remove Api Then Copy This And Send To Bot - `/api None`</blockquote></b>"""


    CLONE_START_TXT = """<b><blockquote>Hᴇʟʟᴏ {},ᴍʏ ɴᴀᴍᴇ {} </blockquote></b>\n\n<b><blockquote>ɪ ᴀᴍ ᴛʜᴇ ᴍᴏsᴛ ᴘᴏᴡᴇʀғᴜʟ ᴀɴᴅ ᴀᴅᴠᴀɴᴄᴇᴅ ғɪʟᴇ sᴛᴏʀᴇ ʙᴏᴛ + ᴄᴜsᴛᴏᴍ sʜᴏʀᴛɴᴇʀ sᴜᴘᴘᴏʀᴛ + ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ sᴜᴘᴘᴏʀᴛ + ᴀʙᴇsᴛ ᴜɪ ᴘᴇʀғᴏʀᴍᴀɴᴄᴇ🎗</blockquote></b>\n<b><blockquote>ᴛᴏ ᴋɴᴏᴡ ᴀʙᴏᴜᴛ ᴍᴇ ᴍᴏʀᴇ ᴜsᴇ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ 🧨</blockquote></b>"""

    ABOUT_TXT = """<b><blockquote>ʜɪ ɪ ᴀᴍ ᴘᴇʀᴍᴀɴᴇɴᴛ ғɪʟᴇ sᴛᴏʀᴇ ʙᴏᴛ ᴡɪᴛʜ ᴄʟᴏɴᴇ ғᴇᴀᴛᴜʀᴇ + ᴄᴜsᴛᴏᴍ ᴜʀʟ sʜᴏʀᴛɴᴇʀ ɪᴛ ᴍᴇᴀɴs ᴀɴʏ ᴜsᴇʀ ᴄᴀɴ sᴇᴛ ʜɪs ᴜʀʟ sʜᴏʀᴛɴᴇʀ ᴀɴᴅ + ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ.</blockquote>
